	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				...
				asik: '*⌛Por favor espere um momento⌛....*',
				success: '*Alhamdulillah funcionou, mana ....!*',
				levelon: 'Ativação do modo de nivelamento com sucesso ✔️',
				leveloff: 'Mode Leveling Sudah Di Nonaktifkan ❌',
				levelnoton: '❌Modo de nivelamento desligado! Peça ao proprietário para ativá-lo ou digite / laporbug [Nome do grupo] Opcional ',
				levelnol: '* PÉS IRMÃOS AINDA * 0> _ <',
				error: {
				...
				only: {
					...
					premium: 'Desculpe, este é um recurso especial para Mods de usuário Eren Yeager ❌
					mod: 'Desculpe, este é um recurso especial para Mods de usuário de Eren Yeager ❌',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] Eu olho para o seu Mukak vovô ! Quem é Você? Você não é o dono. Eu sou reb bot ! Você está com o rosto feio O problema não foi detectado terdeteksi ❌',
					ownerB: '[❗] Eu olho para o seu Mukak vovô ! Quem é Você? Você não é o dono. Eu sou reb bot! Você está com o rosto feio O problema não foi detectado👎 ❌',
           ...
           if (!isUser) return reply(mess.only.userB)
            ...
            break
				...
				if (!isUser) return reply(mess.only.userB)
                	...
                	client.updatePresence(from, Presence.composing) 
					if (!isQuotedVideo) return reply('❌ Falha ao converter vídeo para mp3 ❌❌')
					reply(mess.wait)
